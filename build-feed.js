...
for (const code of PAIR_ORDER) {
  ...
  summary += `  前日: 始値 ${d.prev_open} / 高値 ${d.prev_high} / 安値 ${d.prev_low} / NY終値 ${d.prev_close_ny}` +
  ...
  if (d.weekly_pivot != null) {
    summary += `  週足: 始値 ${d.weekly_open} | Pivot: ${d.weekly_pivot} | R1 ${d.weekly_r1} | S1 ${d.weekly_s1}` +
